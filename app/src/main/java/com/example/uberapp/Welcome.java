...
public class Welcome extends FragmentActivity implements OnMapReadyCallback,
    ...
    private float getBearing(LatLng startPosition, LatLng endPosition) {
        ...
        if(startPosition.latitude<endPosition.latitude&&startPosition.longitude<endPosition.longitude)
        {
            ...
            return  (float) (Math.toDegrees(Math.atan(lng/lat))+100);
        }
        else if (startPosition.latitude<endPosition.latitude&&startPosition.longitude>=endPosition.longitude){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        places.setOnPlaceSelectedListener(new com.google.android.libraries.places.widget.listener.PlaceSelectionListener() {
            @Override
            public void onPlaceSelected(@NonNull Place place) {
                if(location_switch.isChecked()){
                    destination=place.toString();
                    ...
                    .enqueue(new Callback<String>() {
                        ...
                        public void onResponse(Call<String> call, Response<String> response) {
                            try {
                                ...
                                //Animation
                                ValueAnimator polyLineAnimator=ValueAnimator.ofArgb(0,100);
